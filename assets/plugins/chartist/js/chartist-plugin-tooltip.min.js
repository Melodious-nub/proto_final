...
! function(a, b) { "function" == typeof define && define.amd ? define(["chartist"], function(c) { return a.returnExportsGlobal = b(c) }) : "object" == typeof exports ? module.exports = b(require("chartist")) : a["Chartist.plugins.tooltips"] = b(Chartist) }(this, function(a) {
    return function(a, b, c) {
        ...
        function h(a) { return a.innerText || a.textContent }
        ...
        c.plugins = c.plugins || {}, c.plugins.tooltip = function(a) {
            return a = c.extend({}, i, a),
                function(i) {
                    ...
                    function k(b) { o = o || n.offsetHeight, p = p || n.offsetWidth, a.appendToBody ? (n.style.top = b.pageY - o + a.tooltipOffset.y + "px", n.style.left = b.pageX - p / 2 + a.tooltipOffset.x + "px") : (n.style.top = (b.layerY || b.offsetY) - o + a.tooltipOffset.y + "px", n.style.left = (b.layerX || b.offsetX) - p / 2 + a.tooltipOffset.x + "px") }
                    var l = "ct-point";
                    ...
                    }), j("mouseout", l, function() { e(n) }), j("mousemove", null, function(a) { k(a) })
                }
        }
